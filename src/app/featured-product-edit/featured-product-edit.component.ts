...
@Component({
  selector: 'app-featured-product-edit',
  templateUrl: './featured-product-edit.component.html',
  styleUrls: ['./featured-product-edit.component.css']
})
export class FeaturedProductEditComponent implements OnInit {
  ...
  onSubmit()
  {
    ...
    // }
    this.productService.saveFeaturedProducts(result).subscribe(res => {
      if(res){
